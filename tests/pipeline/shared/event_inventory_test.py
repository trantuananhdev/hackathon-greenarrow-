...
from pipeline.download.download_desinventar import download_atomic, materialize_desinventar
from pipeline.shared.event_inventory import build_event_inventory, parse_desinventar_xml
    ...
    def test_download_does_not_publish_unverified_bytes(self):
        with TemporaryDirectory() as directory:
            ...
            with unittest.mock.patch(
                "pipeline.download.download_desinventar.urllib.request.urlopen",
