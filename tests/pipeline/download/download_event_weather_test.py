...
from pipeline.download.download_event_weather import (
    HOURLY_VARIABLES,
    MODEL,
    TIMEZONE,
...
class EventWeatherTest(unittest.TestCase):
    ...
    @patch("pipeline.download.download_event_weather.time.sleep")
    @patch("pipeline.download.download_event_weather.fetch_batch")
