...
from pipeline.download.download_flood import (
    latest_complete_partition,
    validate_flood_part,
)
from pipeline.transform.flood_signal import build_flood_signals
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--river-points",
        type=Path,
        default=Path("data/reference/river_points.parquet"),
    )
    parser.add_argument(
        "--flood-root",
        type=Path,
        default=Path("data/hydrology/flood"),
    )
    parser.add_argument(
        "--signals",
        type=Path,
        default=Path("data/hydrology/flood_signals.parquet"),
    )
