...
from pipeline.download.download_elevation import validate_location_features
from pipeline.download.download_forecast import file_sha256, validate_forecast_part
from pipeline.shared.admin_units import OFFICIAL_NEW_ADMIN_UNITS
from pipeline.shared.data_contract import validate_forecast_output
from pipeline.transform.alert_rules import (
    RULE_VERSION,
...
def main() -> None:
    ...
    parser.add_argument(
        "--alerts-root",
        type=Path,
        default=Path("data/weather/alerts"),
    )
