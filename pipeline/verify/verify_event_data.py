...
from pipeline.download.download_event_weather import event_window, validate_event_part
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--events",
        type=Path,
        default=Path("data/events/desinventar_events.parquet"),
    )
    parser.add_argument(
        "--locations",
        type=Path,
    ...
    parser.add_argument(
        "--context-locations",
        type=Path,
        default=Path("data/events/event_locations.parquet"),
    )
    parser.add_argument(
        "--weather-root",
        type=Path,
        default=Path("data/events/weather"),
    )
