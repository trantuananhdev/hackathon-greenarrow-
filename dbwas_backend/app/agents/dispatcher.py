...
@agent.tool_plain
def query_urgent_policy(weather_condition: str) -> str:
...
@agent.tool_plain
def send_zalo(phone: str, message: str, color_level: str) -> str:
...
@agent.tool_plain
def trigger_auto_call(phone: str, ethnic_lang: str, alert_type: str) -> str:
